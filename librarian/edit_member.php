    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (empty($email)) {
            ...
            if ($stmt->fetch()) {
                ...
                if ($result) {
                    header('Location: view_member.php?id=' . urlencode($userId) . '&success=Member updated successfully');
                    exit;
                } else {
...
<body>
    ...
    <div class="container">
        <div class="page-header">
            ...
            <p>Update information for <?php echo htmlspecialchars($member['first_name'] . ' ' . $member['last_name']); ?></p>
        </div>
