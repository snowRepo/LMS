...
<head>
    ...
    <title>Librarian Account Removed - <?php echo $app_name; ?></title>
</head>
                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background: white; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.1);">
                    <tr>
                        <td style="background: #dc3545; color: white; padding: 30px 20px; text-align: center;">
                            <h1 style="margin: 0; font-size: 28px; font-weight: 300;">Librarian Account Removed</h1>
                    ...
                    <tr>
                        <td style="padding: 30px;">
                            ...
                            <p>We're writing to inform you that your librarian account for <strong><?php echo htmlspecialchars($library_name); ?></strong> has been removed from our Library Management System.</p>
                            
                            <div style="background: #f8d7da; border-left: 4px solid #dc3545; padding: 15px; margin: 20px 0; border-radius: 4px;">
                                <h3 style="margin-top: 0; color: #721c24;">Account Access Revoked</h3>
                                <p>Your access to the library management system has been permanently removed. You will no longer be able to log in or access any library data.</p>
                            </div>
                            ...
                            <div style="background: #fff3cd; border: 1px solid #ffeaa7; color: #856404; padding: 15px; border-radius: 8px; margin: 15px 0;">
                                ...
                                <ul style="padding-left: 20px;">
                                    <li>If you believe this was done in error, please contact your supervisor immediately</li>
                                    <li>If you still have physical access to the library, please return any keys or materials</li>
                            ...
                            <div style="text-align: center; margin-top: 20px;">
                                <p style="margin-top: 30px; color: #6c757d; font-size: 14px;">
                                    If you have any questions or concerns, please contact your supervisor.<br>
                                    Thank you for your service to <?php echo htmlspecialchars($library_name); ?>.
                                </p>
                            </div>
                        </td>
                    </tr>
