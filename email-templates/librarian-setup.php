...
<head>
    ...
    <title>Librarian Account Setup - <?php echo $app_name; ?></title>
</head>
                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background: white; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.1);">
                    <tr>
                        <td style="background: #3498DB; color: white; padding: 30px 20px; text-align: center;">
                            <h1 style="margin: 0; font-size: 28px; font-weight: 300;">Librarian Account Setup</h1>
                    ...
                    <tr>
                        <td style="padding: 30px;">
                            ...
                            <p>You've been added as a librarian to <strong><?php echo htmlspecialchars($library_name); ?></strong> in our Library Management System. To complete your account setup, please verify your email and set your password.</p>
                            ...
                            <div style="background: #f8f9fa; border-left: 4px solid #3498DB; padding: 15px; margin: 20px 0; border-radius: 4px;">
                                ...
                                <ol>
                                    ...
                                    <li>Login to start managing your library</li>
                                </ol>
                            </div>
                            ...
                            <div style="background: #f8d7da; border: 1px solid #f5c6cb; color: #721c24; padding: 15px; border-radius: 8px; margin: 15px 0;">
                                ...
                                <p>This link will expire in 24 hours. After that, you'll need to contact your supervisor to resend the setup email.</p>
                                <p>If you did not expect this email, please ignore it or contact your supervisor.</p>
                            </div>
                            ...
                            <div style="text-align: center; margin-top: 20px;">
                                <p style="margin-top: 30px; color: #6c757d; font-size: 14px;">
                                    If you have any questions or need assistance, please contact your supervisor.<br>
                                    We're here to help make your library management experience as smooth as possible!
                                </p>
                            </div>
                        </td>
                    </tr>
