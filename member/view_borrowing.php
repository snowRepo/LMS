...
// Fetch borrowing details - only for this member
try {
    $db = Database::getInstance()->getConnection();
    
    // Get borrowing details with book information - only for this member
    $stmt = $db->prepare("
        SELECT b.*, 
    ...
    ");
    $stmt->execute([$borrowingId, $_SESSION['user_id']]);
                ...
                <div class="book-info">
                    ...
                    <div class="borrowing-info">
                        ...
                        <div class="info-row">
                            ...
                            <div class="info-value"><?php echo htmlspecialchars($borrowing['issued_by_first_name'] . ' ' . $borrowing['issued_by_last_name']); ?></div>
                        </div>
                        
                        <div class="info-row">
                            <div class="info-label">Transaction ID:</div>
                            <div class="info-value"><?php echo htmlspecialchars($borrowing['transaction_id']); ?></div>
                        </div>
                    </div>
